...
public class TwoDimArrayPractice extends JFrame
{
   ...
   */
   public void printArray( )
   {
    ...
    // Write your code here:
	   ...
	   for(int r =0; r< intArray.length;r++) {//go through rows
		   for(int c =0; c<intArray[r].length;c++) {//go through columns
			   
			   System.out.println(intArray[r][c] + " "); //print
			   
			   animate( r, c );
			   
		   }
		   System.out.println(); // to break when the it finishes going through a row
	   }
   ...
   */
   public void setValues( int value, int row )
   {
    ...
    //  and column is the index of the array's current column
    // Write your code here:
	   for(int c=0; c<intArray[row].length; c++) {// goes through the each element in the row
		   intArray[row][c] = value; //changes the element to value
		   animate( row, c );
	   }
   ...
   */
   public int findMinimum( int column )
   {
    ...
    // Write your code here:
	  int minimum = intArray[0][column]; //start at first row
	  for(int r =0; r<intArray.length;r++) { // go through each row
		  if(intArray[r][column]< minimum) {// check if the element is smaller then the first element checked ie minimum
			  minimum =  intArray[r][column]; //if yes the change that to minimum
		  }
   ...
   */
   public int countFound( int value )
   {
    ...
    // Write your code here:
	   int num = 0; //counter
	   for(int r =0; r< intArray.length;r++) {//go through every row
		   for(int c =0; c<intArray[r].length;c++) {//go through every column 
			   if(intArray[r][c]==value) { // if the element is the same as the given value then increase counter
